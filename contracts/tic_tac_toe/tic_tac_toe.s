...
.LBB7_6:
	...
	i32.and 	$14=, $14, $10
	i32.const	$push98=, 1
	i32.add 	$push97=, $15, $pop98
	tee_local	$push96=, $15=, $pop97
	i32.lt_u	$push19=, $pop96, $6
	br_if   	0, $pop19
.LBB7_7:
	end_loop
	end_block
	i32.const	$push20=, 8
	i32.call	$push107=, _Znwj@FUNCTION, $pop20
	tee_local	$push106=, $15=, $pop107
	i32.store	0($pop106), $13
	i32.store	4($15), $12
	i32.store	0($21), $15
	i32.const	$push105=, 8
	i32.add 	$push104=, $15, $pop105
	tee_local	$push103=, $15=, $pop104
	i32.store	8($21), $pop103
	i32.store	4($21), $15
	...
	block   	
	block   	
	i32.load	$push102=, 0($21)
	tee_local	$push101=, $7=, $pop102
	i32.load	$push100=, 4($21)
	tee_local	$push99=, $9=, $pop100
	i32.eq  	$push22=, $pop101, $pop99
	br_if   	0, $pop22
	copy_local	$15=, $7
.LBB7_9:
	loop    	
	i32.load	$push110=, 0($15)
	tee_local	$push109=, $8=, $pop110
	i32.const	$push108=, 2
	i32.eq  	$push23=, $pop109, $pop108
	br_if   	2, $pop23
	i32.const	$push111=, 1
	i32.eq  	$push24=, $8, $pop111
	br_if   	3, $pop24
	i32.const	$push114=, 4
	i32.add 	$push113=, $15, $pop114
	tee_local	$push112=, $15=, $pop113
	i32.ne  	$push26=, $9, $pop112
	br_if   	0, $pop26
.LBB7_12:
	end_loop
	end_block
...
.LBB7_13:
	...
	block   	
	i64.const	$push115=, 3
	i64.gt_u	$push27=, $17, $pop115
	br_if   	0, $pop27
	i32.load8_s	$push120=, 0($15)
	tee_local	$push119=, $8=, $pop120
	i32.const	$push118=, -97
	i32.add 	$push29=, $pop119, $pop118
...
.LBB7_16:
	...
	i64.le_u	$push28=, $17, $pop122
	br_if   	2, $pop28
	br      	3
.LBB7_17:
	end_block
	i32.const	$push127=, 208
	i32.add 	$push32=, $8, $pop127
	i32.const	$push126=, 0
	i32.const	$push125=, -49
	i32.add 	$push33=, $8, $pop125
	i32.const	$push124=, 255
	i32.and 	$push34=, $pop33, $pop124
	i32.const	$push123=, 5
	i32.lt_u	$push35=, $pop34, $pop123
	i32.select	$8=, $pop32, $pop126, $pop35
.LBB7_18:
	end_block
	i64.extend_u/i32	$push36=, $8
	i64.const	$push129=, 56
	i64.shl 	$push37=, $pop36, $pop129
	i64.const	$push128=, 56
	i64.shr_s	$19=, $pop37, $pop128
.LBB7_19:
	end_block
	i64.const	$push131=, 31
	i64.and 	$push39=, $19, $pop131
	i64.const	$push130=, 4294967295
	i64.and 	$push38=, $16, $pop130
	i64.shl 	$19=, $pop39, $pop38
.LBB7_20:
	end_block
	i32.const	$push137=, 1
	i32.add 	$15=, $15, $pop137
	i64.const	$push136=, 1
	i64.add 	$17=, $17, $pop136
	i64.or  	$18=, $19, $18
	i64.const	$push135=, -5
	i64.add 	$push134=, $16, $pop135
	tee_local	$push133=, $16=, $pop134
	i64.const	$push132=, -6
	i64.ne  	$push40=, $pop133, $pop132
	br_if   	0, $pop40
	end_loop
	i64.const	$17=, 0
	i64.const	$16=, 59
...
.LBB7_22:
	...
	block   	
	i64.const	$push138=, 3
	i64.gt_u	$push41=, $17, $pop138
	br_if   	0, $pop41
	i32.load8_s	$push143=, 0($15)
	tee_local	$push142=, $8=, $pop143
	i32.const	$push141=, -97
	i32.add 	$push43=, $pop142, $pop141
	i32.const	$push140=, 255
	i32.and 	$push44=, $pop43, $pop140
	i32.const	$push139=, 25
	i32.gt_u	$push45=, $pop44, $pop139
	br_if   	1, $pop45
...
.LBB7_25:
	...
	i64.le_u	$push42=, $17, $pop145
	br_if   	2, $pop42
	br      	3
.LBB7_26:
	end_block
	i32.const	$push150=, 208
	i32.add 	$push46=, $8, $pop150
	i32.const	$push149=, 0
	i32.const	$push148=, -49
	i32.add 	$push47=, $8, $pop148
	i32.const	$push147=, 255
	i32.and 	$push48=, $pop47, $pop147
	i32.const	$push146=, 5
	i32.lt_u	$push49=, $pop48, $pop146
	i32.select	$8=, $pop46, $pop149, $pop49
.LBB7_27:
	end_block
	i64.extend_u/i32	$push50=, $8
	i64.const	$push152=, 56
	i64.shl 	$push51=, $pop50, $pop152
	i64.const	$push151=, 56
	i64.shr_s	$19=, $pop51, $pop151
.LBB7_28:
	end_block
	i64.const	$push154=, 31
	i64.and 	$push53=, $19, $pop154
	i64.const	$push153=, 4294967295
	i64.and 	$push52=, $16, $pop153
	i64.shl 	$19=, $pop53, $pop52
.LBB7_29:
	end_block
	i32.const	$push160=, 1
	i32.add 	$15=, $15, $pop160
	i64.const	$push159=, 1
	i64.add 	$17=, $17, $pop159
	i64.or  	$20=, $19, $20
	i64.const	$push158=, -5
	i64.add 	$push157=, $16, $pop158
	tee_local	$push156=, $16=, $pop157
	i64.const	$push155=, -6
	i64.ne  	$push54=, $pop156, $pop155
	br_if   	0, $pop54
	end_loop
