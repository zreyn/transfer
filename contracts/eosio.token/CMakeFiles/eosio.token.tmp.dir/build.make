...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.o: ../contracts/eosio.token/eosio.token.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/Users/zanereynolds/workspace/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.o"
	cd /Users/zanereynolds/workspace/eos/build/contracts/eosio.token && /usr/local/bin/clang++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.o -c /Users/zanereynolds/workspace/eos/contracts/eosio.token/eosio.token.cpp
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.i: cmake_force
	...
	cd /Users/zanereynolds/workspace/eos/build/contracts/eosio.token && /usr/local/bin/clang++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /Users/zanereynolds/workspace/eos/contracts/eosio.token/eosio.token.cpp > CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.i
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.s: cmake_force
	...
	cd /Users/zanereynolds/workspace/eos/build/contracts/eosio.token && /usr/local/bin/clang++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /Users/zanereynolds/workspace/eos/contracts/eosio.token/eosio.token.cpp -o CMakeFiles/eosio.token.tmp.dir/eosio.token.cpp.s
...
contracts/eosio.token/eosio.token.tmp: contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/Users/zanereynolds/workspace/eos/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable eosio.token.tmp"
	cd /Users/zanereynolds/workspace/eos/build/contracts/eosio.token && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/eosio.token.tmp.dir/link.txt --verbose=$(VERBOSE)
...
contracts/eosio.token/CMakeFiles/eosio.token.tmp.dir/clean:
	cd /Users/zanereynolds/workspace/eos/build/contracts/eosio.token && $(CMAKE_COMMAND) -P CMakeFiles/eosio.token.tmp.dir/cmake_clean.cmake
